...
},
{
  ...
  "number": "2.5",
  "title": "",
  "body": "  Let be given by   for all .   Give a short proof that (using any properties of or theorems we proved).  Prove that using only the - definition of the functional limit.       The function is a polynomial, so it is continuous. This means     Let's do some preliminary work. Notice that   If we ensure that , then so that adding across this inequality gives and . Under this assumption, , so we can choose .  Proof: Let . Let . For any such that , we know that so that . This means      "
},
{
